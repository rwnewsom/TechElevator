...
namespace MattEland.LinqSamples
{
    public class BookProvider
    {
        ...
        private static IEnumerable<Book> GetBooks([CallerMemberName] string caller = "")
        {
            ...
            {
                new Book("Sphere", "Michael Crichton", Genre.ScienceFiction, 9.99M, new List<string>()
                {
                    "Harry",
                    "Norman",
                    "Beth",
                ...
                new Book("Jurassic Park", "Michael Crichton", Genre.ScienceFiction, 14.99M, new List<string>()
                {
                    "Malcolm",
                    "Grant",
                    "Satler",
                ...
                new Book("Working Effectively with Legacy Code", "Michael Feathers",  Genre.Technical, 45.99M, new List<string>()),
                new Book("Your Code as a Crime Scene", "Adam Tornhill", Genre.Technical, 35.99M, new List<string>()),
                new Book("Software Design X-Rays", "Adam Tornhill", Genre.Technical, 32.99M, new List<string>())
            };
