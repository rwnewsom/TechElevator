...
namespace HTTP_Web_Services_GET_lecture.ApiClients
{
    public class HotelsApi
    {
        ...
        {
            RestRequest request = new RestRequest(BASE_URL + "hotels/" + hotelId); // https://te-mockauction-server.azurewebsites.net/students/01798/hotels/5
