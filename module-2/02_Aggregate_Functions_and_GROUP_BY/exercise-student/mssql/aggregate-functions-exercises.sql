...
SELECT
	name,
	(gnp-gnpold) AS 'GNP Change',
	ABS(gnp-gnpold) AS 'GNP Delta'
FROM
	country
WHERE 
	gnp IS NOT NULL 
...
SELECT
	continent,
	AVG(lifeexpectancy) AS 'AVG Life Exp.',
	MIN(lifeexpectancy) AS 'MIN Life Exp.',
	MAX(lifeexpectancy) AS 'MAX Life Exp.'
FROM
	country
