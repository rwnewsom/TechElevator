...
INSERT INTO facts (quote)
VALUES ('Chuck Norris CAN divide by 0'), 
	   ('Chuck Norris has a keyboard with only 3 keys: 0, 1, and deploy to production')

-- Reference SQL

-- SELECT id, quote FROM facts ORDER BY quote
